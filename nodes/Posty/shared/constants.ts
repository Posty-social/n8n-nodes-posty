...
export const MEDIA_CONTENT_TYPE_OPTIONS: INodePropertyOptions[] = [
	...
	{ name: 'JPEG Image', value: 'image/jpeg', description: 'MIME type image/jpeg' },
	...
	{ name: 'QuickTime Video', value: 'video/quicktime', description: 'MIME type video/quicktime' },
	{ name: 'WebP Image', value: 'image/webp', description: 'MIME type image/webp' },
];
