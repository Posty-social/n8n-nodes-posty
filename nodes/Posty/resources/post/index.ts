		...
		options: [
			{
				...
				routing: {
					request: { method: 'POST', url: actionsUrl, body: { action: 'approve' } },
				},
			},
			{
				name: 'Create',
			...
			},
			{
				...
				routing: {
					request: { method: 'DELETE', url: '=/v1/posts/{{$parameter.postId}}' },
			...
			},
			{
				...
				value: 'get',
				action: 'Get a post',
				description: 'Get a post including its per-channel content and delivery state',
				routing: {
			...
			},
			{
				...
				description: 'Get the revisions, approvals and events recorded for a post',
				routing: {
					request: { method: 'GET', url: '=/v1/posts/{{$parameter.postId}}/history' },
				},
			},
			{
				name: 'Get Many',
			...
			},
			{
				...
				routing: {
					request: { method: 'POST', url: actionsUrl, body: { action: 'publish' } },
				},
			},
			{
				...
				routing: {
					request: { method: 'POST', url: actionsUrl, body: { action: 'request_changes' } },
				},
			},
			{
				...
				description: 'Queue the channels whose delivery failed for another attempt',
				routing: {
					request: { method: 'POST', url: actionsUrl, body: { action: 'retry' } },
				},
			},
			{
				...
				routing: {
					request: { method: 'POST', url: actionsUrl, body: { action: 'submit' } },
				},
			},
			{
				name: 'Update',
