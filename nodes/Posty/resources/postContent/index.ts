...
import {
  ...
  postContentSetMediaPreSend,
} from "./setMedia";
import {
  postContentUpdateDescription,
  postContentUpdatePreSend,
} from "./update";

const contentUrl =
  "=/v1/posts/{{$parameter.postId}}/content/{{$parameter.channelId}}";
    ...
    options: [
      {
        ...
        description:
          "Remove the content for one channel so the post no longer targets it",
        routing: {
      ...
      },
      {
        ...
        description:
          "Replace the media attached to the content for one channel",
        routing: {
