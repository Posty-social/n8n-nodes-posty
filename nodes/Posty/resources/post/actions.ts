...
export const postActionsDescription: INodeProperties[] = [
  ...
  },
  {
    ...
    required: true,
    description:
      "What needs to change. Added to the post as a change-request comment.",
    displayOptions: {
      show: { resource: ["post"], operation: ["requestChanges"] },
    },
  ...
  },
  {
    ...
    default: "now",
    description:
      "Whether to deliver immediately or lock the post in for its scheduled time",
